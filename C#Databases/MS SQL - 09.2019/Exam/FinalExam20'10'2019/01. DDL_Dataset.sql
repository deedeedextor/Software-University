...
('Ayrton', 'Sennay', '1960-03-21', 9),
('Ronnie', 'Petersony', '1944-02-14', 9),
...
---Problem 5
SELECT [Description],
       CONVERT(VARCHAR(10), OpenDate, 105) AS [OpenDate]
FROM Reports
WHERE EmployeeId IS NULL
ORDER BY CAST(OpenDate AS DATE) ASC, [Description]
...
BEGIN 
	 ...
	 DECLARE @ReportDepartmentId INT = (SELECT d.Id FROM Reports AS r
	                                     JOIN Categories AS c ON r.CategoryId = c.Id
