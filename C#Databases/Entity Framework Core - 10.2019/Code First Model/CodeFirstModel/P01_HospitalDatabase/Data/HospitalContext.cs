namespace P01_HospitalDatabase.Data
{
    ...
    public class HospitalContext : DbContext
    {
        ...
        private static void ConfigurationOnDoctor(ModelBuilder modelBuilder)
        {
            modelBuilder
                .Entity<Doctor>()
                .HasKey(k => k.DoctorId);
        ...
        private static void ConfigurationOnMedicament(ModelBuilder modelBuilder)
        {
            modelBuilder
                .Entity<Medicament>()
        ...
        private static void ConfigurationOnVisitation(ModelBuilder modelBuilder)
        {
            modelBuilder
                .Entity<Visitation>()
        ...
        private static void ConfigurationOnPatient(ModelBuilder modelBuilder)
        {
            modelBuilder
                .Entity<Patient>()
